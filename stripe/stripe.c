                     ...
                     int *num_faces,int *num_tris,int *num_buffers,int f) 
{
  ...
  printf ("Saw vertices: %d, normals: %d, textures: %d\n", *num_vert,
	  *num_nvert, *num_texture); 
}
...
void main (int argc,char *argv[])
{
  ...
  /* Hurrm.  Set some random uninitialised globals.  */ 
  Set_Norms (vert_norms, num_nvert, vert_texture, num_texture);
